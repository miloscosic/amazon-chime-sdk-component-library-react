...
export const StyledControlBarItem = styled.div<StyledControlBarItemProps>`
  ...
  .ch-control-bar-item-iconButton {
    color: ${({ theme, isActive }) => isActive ? `${theme.controlBar.active.text}` : theme.controlBar.text};
    background-color: ${({ isActive, theme }) =>  isActive ? `${theme.controlBar.active.bgd}` : 'inherit'};
